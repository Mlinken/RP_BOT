...
TOD_TRUTHS = [
    ...
    "Яка еротична сцена з фільму чи книги збуджує тебе найбільше?",
    "Яку першу секс-іграшку ти б хотів(-ла) собі купити у майбутньому?",
    "Які еротичні сни тобі зазвичай сняться?",
    "Яку частину свого тіла ти вважаєш найсексуальнішою?",
    "Який романтичний або пристрасний вчинок ти мрієш зробити під час першого сексу?",
    "Які звуки чи слова під час близькості здаються тобі найгарячішими?",
    "Чи дивишся ти порно або читаєш еротичні фанфіки/історії?",
    "Який одяг на протилежній (або твоїй) статі здається тобі найбільш збудливим?",
    "Як ти уявляєш своє ідеальне перше побачення, яке закінчиться зближенням?",
    "Що тебе найбільше лякає і водночас приваблює у темі сексу?",
]
...
TOD_DARES = [
    ...
    "Знайди в інтернеті та надішли посилання на фото хлопця/дівчини, які є твоїм сексуальним ідеалом.",
    "Увімкни камеру і повільно, дивлячись в екран, розстебни верхні ґудзики сорочки або зніми один елемент одягу.",
    "Знайди в мережі картинку або мем, який найкраще описує твої еротичні фантазії, і скинь у чат.",
    "Одягни найсексуальнішу річ зі свого гардероба (навіть якщо це просто обтисла футболка) і покажися на 1 хвилину.",
]
